...
for (const statement of [
  ...
  'ALTER TABLE bookings ADD COLUMN pre_order TEXT',
  'ALTER TABLE bookings ADD COLUMN payment_method TEXT DEFAULT \'none\'',
...
export function bootstrap() {
  ...
  if (tableCount === 0) {
    ...
    const seedTables = [
      ...
      { id: 14, hall: 1, number: 14, title: 'Стол №14', zone: 'banquet', seats: 4, status: 'free', x: 384, y: 240, width: 62, height: 62, shape: 'rect', scene: 'большой стол для компании' },
      ...
      { id: 24, hall: 2, number: 24, title: 'Стол №24', zone: 'window', seats: 4, status: 'free', x: 714, y: 190, width: 70, height: 72, shape: 'rect', scene: 'у окна, мягкий вечерний свет' },
      ...
      { id: 32, hall: 2, number: 32, title: 'Стол №32', zone: 'lounge', seats: 4, status: 'free', x: 366, y: 320, width: 124, height: 62, shape: 'rect', scene: 'диваны, лампы и спокойная зона' },
...
function ensureTableMigrationV2() {
  ...
  const tx = db.transaction(() => {
    ...
    const rows = [
      ...
      [3, 'lounge', 4, 'free', 448, 760, 142, 76, 'rect', 'лаунж-зона, спокойный ритм', 24],
      ...
      [3, 'bar', 4, 'free', 830, 390, 152, 86, 'rect', 'возле бара, динамичный вечер', 32],
...
function seedMenu() {
  ...
  const seed = [
    ...
    },
    {
      name: 'Соусы',
      items: [
        { title: 'Сырный соус', weight: '50 г', price: 60 },
        { title: 'Чесночный соус', weight: '50 г', price: 60 },
        { title: 'Соус BBQ', weight: '50 г', price: 60 },
        { title: 'Тартар', weight: '50 г', price: 60 },
        { title: 'Перечный соус', weight: '50 г', price: 60 },
        { title: 'Кетчуп', weight: '50 г', price: 60 },
        { title: 'Сметана', weight: '50 г', price: 60 },
        { title: 'Ореховый соус', weight: '50 г', price: 60 },
        { title: 'Терияки', weight: '50 г', price: 60 },
      ],
    },
  ]
  ...
  const imageByTitle = {
    'Ореховый цыплёнок': '/assets/menu/Orekhovyy-tsyplenok.webp',
    'Бургер с брискетом': '/assets/menu/Burger-s-brisketom.webp',
    'Мясной сет': '/assets/menu/Myasnoy-set.webp',
    ...
    'Подкопчёная утиная грудка': '/assets/menu/Podkopchenaya-utinaya-grudka.webp',
    'Грузди со сметаной': '/assets/menu/Gruzdi-so-smetanoy.webp',
    'Лосось слабосолёный': '/assets/menu/Losos-slaboy-soli.webp',
    'Чесночные гренки': '/assets/menu/Chesnochnye-grenki.webp',
    'Крылья копчёные': '/assets/menu/Kopchenye-krylya.webp',
    'Крылья BBQ': '/assets/menu/Krylya-BBQ.webp',
    'Сырные палочки': '/assets/menu/Syrnye-palochki.webp',
    'Стрипсы из говядины': '/assets/menu/Stripsy-iz-govyadiny.webp',
    'Цезарь с курицей': '/assets/menu/Tsezar-s-kuritsey.webp',
    'Цезарь с креветками': '/assets/menu/Tsezar-s-krevetkami.webp',
    'Из жареных баклажанов с томатами и кунжутным кремом': '/assets/menu/Salat-s-zharenymi-baklazhanami.webp',
    'С утиной грудкой': '/assets/menu/Salat-s-utkoy.webp',
    'С тунцом, печёными цуккини и имбирной заправкой': '/assets/menu/Salat-s-tuntsom.webp',
    ...
    'Щучьи котлеты с картофельным пюре': '/assets/menu/Shchuchi-kotlety.webp',
    'Домашние котлеты с картофельным пюре': '/assets/menu/Domashnie-kotlety.webp',
    'Borshch': '/assets/menu/Borshch.webp',
    'Норвежская уха': '/assets/menu/Norvezhskaya-ukha.webp',
    'Сырный суп': '/assets/menu/Syrnyy-sup.webp',
    ...
    'Бифштекс с яйцом': '/assets/menu/Bifshteks.webp',
    ...
    'Колбаски из свинины': null,
    'Колбаски из говядины': null,
    'Колбаски из птицы': null,
    CHEETOS: '/assets/menu/Rebra-BBQ.webp',
    BBQ: '/assets/menu/Rebra-BBQ.webp',
    'В сосновой глазури с мёдом': null,
    'Губы Гудбай': null,
    'Картофель фри': '/assets/menu/Kartofel-fri.webp',
    'Мексиканский овощной гарнир': '/assets/menu/Meksikanskiy-garnir.webp',
    ...
    'Сырный соус': '/assets/menu/Sous-syrnyy.webp',
    'Чесночный соус': '/assets/menu/Sous-chesnochnyy.webp',
    'Соус BBQ': '/assets/menu/Sous-BBQ.webp',
    'Тартар': '/assets/menu/Sous-tartar.webp',
    'Перечный соус': '/assets/menu/Sous-perechnyy.webp',
    'Кетчуп': '/assets/menu/Sous-ketchup.webp',
    'Сметана': '/assets/menu/Sous-smetana.webp',
    'Ореховый соус': '/assets/menu/Sous-orekhovyy.webp',
  }
